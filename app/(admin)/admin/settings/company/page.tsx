...
import DistributeProfitsConfirmationModal from "@/components/admin/settings/company/DistributeProfitsConfirmationModal";
import DistributeProfitsModal from "@/components/admin/settings/company/DistributeProfitsModal";
...
const Page = () => {
  ...
  const [showDistributeConfirmation, setShowDistributeConfirmation] =
    useState(false);
  ...
  return (
    <>
      ...
      <DistributeProfitsModal
        opened={showDistribute}
        onClose={() => setShowDistribute(false)}
        showConfirmation={() => setShowDistributeConfirmation(true)}
        company={company}
      />

      <DistributeProfitsConfirmationModal
        opened={showDistributeConfirmation}
        onClose={() => setShowDistributeConfirmation(false)}
        company={company}
      />

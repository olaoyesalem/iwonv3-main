...
export const PATCH = async (
  ...
  try {
    ...
    const transaction = await Transaction.findByIdAndUpdate<TransactionType>(
    ...
    if (transaction.linkedTransactionId) {
      const pendingTransaction = await Transaction.findById<TransactionType>(
    ...
    const updatedTransaction = await Transaction.findById<TransactionType>(
      params.transactionId
    );

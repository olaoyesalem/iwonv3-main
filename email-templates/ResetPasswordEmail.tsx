...
export const ResetPasswordEmail = (props: ResetPasswordEmailProps) => {
  const { userFirstname, resetPasswordCode, company, isPin } = props;
  const forValue = isPin ? "PIN" : "Password";

  return (
    <Html>
      <Head />
      <Preview>Reset your {forValue}</Preview>
      <Body style={main}>
        <Container style={container}>
          <Section style={logo}>
            <Img
              style={{ margin: "0 auto" }}
              src={"https://iwon.vc/logo-black-landscape.png"}
              width="auto"
              height="60"
              alt={company.name}
            />
          ...
          <Section>
            ...
            <Text style={text}>
              Someone recently requested a {forValue} change for your{" "}
              {company.name}
            ...
            <Text style={text}>
              If you don&apos;t want to change your {forValue} or didn&apos;t

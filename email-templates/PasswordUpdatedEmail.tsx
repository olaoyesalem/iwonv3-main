...
export const PasswordUpdated = (props: TwitchResetPasswordEmailProps) => {
  const { username, updatedDate, company, newPin } = props;
  ...
  return (
    <Html>
      <Head />
      <Preview>
        You updated the {newPin ? "PIN" : "Password"} for your {company.name}{" "}
        account
      </Preview>
      <Body style={main}>
        <Container style={container}>
          ...
          <Section style={content}>
            ...
            <Text style={paragraph}>
              You updated the {newPin ? "PIN" : "Password"} for your{" "}
              {company.name} account on {formattedDate}. If this was you, then
              no further action is required.
            </Text>

            <Text style={paragraph}>
              Remember to use a {newPin ? "PIN" : "Password"} that is both
              strong and unique to your
              {company.name} account. To learn more about how to create a strong
              and unique {newPin ? "PIN" : "Password"},
